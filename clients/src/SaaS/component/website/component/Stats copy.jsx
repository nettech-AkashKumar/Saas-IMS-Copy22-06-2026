            ...
            <section className="card card--form" aria-label="Multi-step form">
              <div className="card__head">
                ...
                <div className="actions">
                  <button className="btn btn--ghost" type="button" onClick={() => setForm({ ...form, ...{
                    fullName: 'Priya Sharma', email: 'priya@company.com', phone: '9876543210', budget: '2500', companyName: 'Orion Tech Labs', industry: 'SaaS', teamSize: '6-25', timelineWeeks: '6', projectType: 'Dashboard app', usersCount: '1200', features: 'Auth, role access, reports', priority: 'Speed', delivery: 'Milestones',
                  } })}>
