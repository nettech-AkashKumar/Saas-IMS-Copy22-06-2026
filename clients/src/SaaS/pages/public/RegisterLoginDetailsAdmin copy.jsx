...
import login_background from "../../assets/Image/bg.png";
...
const AuthPage = () => {
  ...
  // const sendOtp = async (showSuccess = true) => {
  //   console.log("[DEBUG] Sending OTP to:", form.adminEmail); // Debug log
  //   if (!form.adminEmail || !form.adminEmail.includes("@")) {
  ...
  return (
    <div className="auth-wrapper auth-wrapper--premium">
      ...
      <div className="container-fluid h-100 auth-layout-shell">
        <div className="row h-100 g-0 auth-layout-row">
          {/* LEFT PANEL */}
          <div className="col-lg-6 d-flex align-items-center justify-content-center auth-right auth-form-pane">
            <div className="card auth-card shadow-lg w-100 d-flex flex-column auth-form-card">
              {/* Sticky Header: logo, title, progress, stepper */}
              <div className="card-header bg-white p-0 auth-sticky-head">
                <div className="text-center pt-4 pb-2 px-4 auth-head-copy">
                  <div className="auth-head-badges" aria-hidden="true">
                    <span className="auth-pill">Enterprise Ready</span>
                    <span className="auth-pill auth-pill--soft">
                      Secure Onboarding
                    </span>
                  </div>
                  <img src={munc_logo} className="logo mb-2" alt="logo" />
                  <h5 className="auth-main-title">
                    Build Your Smart Workspace
                  </h5>
                  <p className="text-muted small mb-0 auth-subtitle">
                    Premium onboarding flow with secure setup, fast
                    verification, and modern account provisioning.
                  </p>
                </div>
                {/* PROGRESS + STEPPER */}
                <div className="progressWrap px-4 pb-2 auth-progress-wrap">
              ...
              <div className="card-body p-4 auth-scroll-body">
                {/* FORM */}
                <form onSubmit={(e) => e.preventDefault()}>
                  {step === 0 && (
                    <div
                      className="auth-step-surface"
                      style={{
                        background: "#f8f9fc",
                  ...
                  {step === 1 && (
                    ...
                    >
                      ...
                      {/* <div
                        style={{
                          background:
                            "linear-gradient(135deg, #0447AA 0%, #0084FF 100%)",
                          padding: "14px 20px",
                          display: "flex",
                          alignItems: "center",
                          gap: "10px",
                  ...
                  {/* BUTTONS */}
                  <div className="d-flex justify-content-between mt-4 auth-action-row">
                    <button
                      type="button"
                      className="btn btn-light auth-nav-btn"
                      onClick={handlePrev}
                      disabled={step === 0}
                    >
                      Back
                    ...
                    {step < steps.length - 1 ? (
                      ...
                      <button
                        type="button"
                        className="btn btn-success auth-nav-btn"
          ...
          <div className="col-lg-6 d-none d-lg-flex align-items-center justify-content-center auth-left auth-visual-pane">
            <img
              src={login_background}
              className="img-fluid auth-img premium-hero-image"
              alt="inventory"
            />
          </div>
        </div>
...
//   const navigate = useNavigate();
//   // Local state for admin login details
...
//   // Step 1: Validate all fields and save to context
//   const handleNext = () => {
//     if (!form.adminName || !form.adminEmail || !form.adminPassword || !form.phone) {
//       return alert("All fields are required");
//     }
//     // Save admin details to context for next steps
//     setRegisterData({
//       ...registerData,
//       adminName: form.adminName,
//       adminEmail: form.adminEmail,
...
//     setLoading(true);
//     try {
//       const res = await fetch(`${BASE_URL}/api/public/verify-otp`, {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({ email: form.adminEmail, otp: code }),
//       });
//       const data = await res.json();
...
//     const newOtp = [...otp];
//     newOtp[idx] = value ? value.slice(-1) : "";
//     setOtp(newOtp);
...
//                     <label style={{ fontWeight: "400", fontSize: "clamp(12px,2vw,14px)", color: "#000000" }}>Full Name</label>
//                     <input
//                       value={form.adminName}
...
//                       style={{ width: "400px", border: "1px solid #DEDEDE", backgroundColor: "#FBFBFB", borderRadius: "8px", padding: "12px 16px", outline: "none" }}
//                     />
//                   </div>
//                   {/* Email */}
//                   <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
//                     <label style={{ fontWeight: "400", fontSize: "clamp(12px,2vw,14px)", color: "#000000" }}>Email</label>
//                     <input
//                       value={form.adminEmail}
...
//                   {/* Phone Number */}
//                   <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
//                     <label style={{ fontWeight: "400", fontSize: "clamp(12px,2vw,14px)", color: "#000000" }}>Phone Number</label>
//                     <input
//                       value={form.phone}
...
//                   {/* Password */}
//                   <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
//                     <label style={{ fontWeight: "400", fontSize: "clamp(12px,2vw,14px)", color: "#000000" }}>Password</label>
//                     <input
//                       value={form.adminPassword}
...
//                     style={{ backgroundColor: "#0084FF", padding: "12px 16px", borderRadius: "8px", width: "400px", border: "none", color: "white" }}
//                     disabled={loading}
//                   >
...
//                 <>
//                   <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
//                     <label style={{ fontWeight: "400", fontSize: "clamp(12px,2vw,14px)", color: "#000000" }}>Enter OTP</label>
...
//                           onChange={e => handleOtpChange(e, idx)}
//                           onKeyDown={e => handleOtpKeyDown(e, idx)}
//                           style={{ width: "48px", height: "48px", fontSize: "22px", textAlign: "center", border: "1px solid #ccc", borderRadius: "8px", outline: "none" }}
//                         />
//                       ))}
//                     </div>
//                   </div>
//                   <button
//                     className='input-all-box'
//                     style={{ backgroundColor: "#0084FF", padding: "12px 16px", borderRadius: "8px", width: "400px", border: "none", color: "white", fontSize: "clamp(14px,2vw,16px)", fontWeight: "500" }}
              ...
              <form onSubmit={registerCompany}>
                  ...
                  <div className="form-section">
                    ...
                    <div className="form-row">
                      <div className="form-col">
                        ...
                        {errors.adminName ? (
                          <small className="error-text">{errors.adminName}</small>
                        ) : (
                      ...
                      <div className="form-col">
                        ...
                        {errors.adminPhone ? (
                          <small className="error-text">{errors.adminPhone}</small>
                        ) : (
                          <small className="hint-text">
                            10-digit mobile number without country code
                          </small>
                ...
                {step === 1 && (
                  <div className="form-section">
                    ...
                    <div className="section-header">Organisation Profile</div>
                    ...
                    <div className="form-row">
                      ...
                      <div className="form-col">
                        ...
                        <div
                          className="form-select industry-select"
                          onClick={() => setshowSelectIndustry(true)}
                        >
                        ...
                        {errors.industry ? (
                          <small className="error-text">{errors.industry}</small>
                        ) : (
                          <small className="hint-text">
                            Sector your company operates in
                          </small>
                    ...
                    {/* Online Presence */}
                    <div className="section-header">Online Presence</div>
                    ...
                    <div className="form-row">
                      <div className="form-col">
                        ...
                        <div className="input-wrapper">
                          ...
                          />
                          <span className="input-suffix">.munc.com</span>
                        </div>
                        {errors.subdomain ? (
                          <small className="error-text">
                            {errors.subdomain}
