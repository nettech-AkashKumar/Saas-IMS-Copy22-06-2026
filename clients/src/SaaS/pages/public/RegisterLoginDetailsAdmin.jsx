...
const RegisterLoginDetailsAdmin = () => {
  ...
  const validateAdminStep = () => {
    ...
    if (!patterns.name.test(form.adminName.trim()))
      newErrors.adminName = "Enter valid admin name";
  ...
  const validateCompanyStep = () => {
    ...
    if (!patterns.companyPhone.test(form.companyPhone))
      newErrors.companyPhone = "Enter valid company phone 10-digits)";
  ...
  const sendOtp = async (showSuccess = true) => {
    const emailValue = form.adminEmail.trim();
    ...
    if (resendTimer > 0 && otpSent && emailValue === lastOtpEmail) {
      notifyError("OTP already sent. Please wait before requesting again.");
      return false;
    }
    ...
    <div className="auth-wrapper">
                      ...
                      >
                        ...
                        <button
                          ...
                          disabled={
                            ...
                            otpVerified ||
                            (resendTimer > 0 &&
                              form.adminEmail.trim() === lastOtpEmail)
                          }
                        >
                          {loading
                            ? "Sending..."
      ...
      <div className="auth-container auth-right-section">
        <div className="adminformlayout">
          ...
          <h1 className="adminformlayout-title">
            Smart Inventory <br /> Better Business
          </h1>

          <p className="adminformlayout-subtitle">
            Manage your stock, orders, sales and suppliers in one powerful
            platform.
          </p>

          <div className="adminformlayout-features">
          ...
          <div className="adminformlayout-image">
