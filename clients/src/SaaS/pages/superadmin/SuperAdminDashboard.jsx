...
//                   <div>
//                     <span className="dot dot-free" /> Free base
//                     <strong>{compactNumber(stats.freeUsers ?? 0)}</strong>
//                   </div>

//                   <div>
//                     <span className="dot dot-active" /> Active companies
//                     <strong>{compactNumber(stats.activeCompanies ?? 0)}</strong>
//                   </div>

//                   <div>
//                     <span className="dot dot-new" /> New signups
...
//               <span>
//                 Page {paginationPage} / {totalPages}
//               </span>
//             </div>
//           </div>
...
// import "./SuperAdminDashboard.css";
// import Sidebar from "./Sidebar";
// import CompanyPanel from "./companyDetails/CompanyPannel";
// import CompanyOperations from "././companyDetails/CompanyOperations";
// import CompanyDetails from "././companyDetails/CompanyDetails";
// import ReminderPage from "./ReminderPage";
// import CreateReminder from "./CreateReminder";
// import ReminderTemplates from "./ReminderTemplates";
// import Revenue from "./Revenue";
// import Hero from "./WebsiteSettings/Hero/Hero";
// import Pricing from "./WebsiteSettings/Pricing/Pricing";
// import Faqs from "./WebsiteSettings/Faqs/Faqs";
// import {
//   approveCompany,
//   deleteTenant,
//   getDashboardStats,
...
//         label: "Active Companies",
//         value: stats.activeCompanies ?? 0,
//         meta: `${Math.max((stats.totalCompanies ?? 0) - (stats.activeCompanies ?? 0), 0)} pending`,
//         tone: "green",
//       },
//       {
//         label: "Employees Managed",
...
//         value:
//           stats.totalCompanies > 0
//             ? `${Math.round(((stats.activeCompanies ?? 0) / stats.totalCompanies) * 100)}%`
//             : "0%",
//       },
//       {
//         label: "New Signups",
...
//       {currentPage === "companies" && selectedCompanyId ? (
//         <CompanyDetails
...
//             </div>
//           </header>
//           <CompanyOperations onSelectCompany={handleSelectCompany} />
//         </main>
...
//               <div>
//                 <p className="sa-eyebrow">Super Admin Dashboard</p>
//                 <h1>Company Reminder Center</h1>
//               </div>
//             </div>
//           </header>
//           <ReminderPage
//             onOpenTemplates={() => setCurrentPage("templates")}
//             onOpenCreateReminder={() => setCurrentPage("createReminder")}
//           />
//         </main>
...
//           </header>
//           <ReminderTemplates
//             onBack={() => setCurrentPage("reminder")}
//             onOpenCreateReminder={(template) => {
//               setTemplateForEdit(template || null);
//               setCurrentPage("createReminder");
//             }}
...
//                       <span className="dot dot-active" /> Active companies
//                       <strong>
//                         {compactNumber(stats.activeCompanies ?? 0)}
//                       </strong>
//                     </div>
//                     <div>
//                       <span className="dot dot-new" /> New signups
//                       <strong>
//                         {compactNumber(stats.newSignupsToday ?? 0)}
//                       </strong>
//                     </div>
//                   </div>
//                 </div>
...
//                         <div>
//                           <em
//                             className={`status-pill ${item.status === "Active" ? "is-active" : "is-pending"}`}
//                           >
//                             {item.status}
//                           </em>
//                           <small>{item.time}</small>
