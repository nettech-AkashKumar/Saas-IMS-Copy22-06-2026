      ...
      <div className="cdp-card">
              ...
              {isEditingMaxEmployees ? (
                <div className="max-employees-input-group">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setMaxEmployeesInput((current) => current + 1)
                    }
                    disabled={actionLoading}
                  >
                    +
        ...
        <div className="Company-wrapper">
          <div className="faqs-tabs">
            <button
              className={`tab-btn ${activeTab === "companyDetails" ? "active" : ""}`}
              onClick={() => setActiveTab("companyDetails")}
            >
              Company Operations
            </button>
            <button
              className={`tab-btn ${activeTab === "companymodules" ? "active" : ""}`}
              onClick={() => setActiveTab("companymodules")}
            >
              Company Module Permissions
            </button>

            <button
              className={`tab-btn ${activeTab === "companyusers" ? "active" : ""}`}
          ...
          <div className="faqs-content">
            {activeTab === "companyDetails" && (
              <CompanyOperations company={company} />
            )}
            {activeTab === "companymodules" && (
              <PermissionModuls companyId={companyId} />
            )}
