...
const EditWarehouseModal = ({ selectedWarehouseId, onClose, onUpdated }) => {
    ...
    const fetchFormData = async () => {
        try {
            const res = await api.get(`/api/warehouse/${selectedWarehouseId}`);
    ...
    const fetchUsers = async () => {
        const res = await api.get('/api/user/status/active');
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await api.put(`/api/warehouse/${selectedWarehouseId}`, {
                ...form,
    ...
    const handleDelete = async () => {
        ...
        try {
            await api.delete(`/api/warehouse/${selectedWarehouseId}`);
