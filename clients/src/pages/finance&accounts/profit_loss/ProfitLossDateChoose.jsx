...
const ProfitLossDateChoose = () => {
  const data = [
    { product: "Chair", amount: "₹ 205.00", taxes: "5%", netProfit: "₹ 65.00", qty: "3 Pieces * 2 Variants" },
    { product: "Chair", amount: "₹ 205.00", taxes: "5%", netProfit: "₹ 65.00", qty: "3 Pieces * 2 Variants" },
    { product: "Chair", amount: "₹ 205.00", taxes: "5%", netProfit: "₹ 65.00", qty: "3 Pieces * 2 Variants" },
    { product: "Chair", amount: "₹ 205.00", taxes: "5%", netProfit: "₹ 65.00", qty: "3 Pieces * 2 Variants" },
    ...
    <div className='page-wrapper d-flex flex-column gap-4'>
      ...
      <div style={{ padding: "0 50px" }}>
        <div className='d-flex justify-content-between align-items-center' style={{width:'100%'}}>
          <div className='d-flex align-items-center gap-1' style={{ border: "1px solid #E6E6E6", borderRadius: "8px", width: "82%", backgroundColor: "white", padding: "8px 24px" }}>
      ...
      <div className='d-flex flex-column justify-content-center align-items-center gap-4'>
        ...
        <div style={{ backgroundColor: "white", borderRadius: "8px", width: "1200px", padding: "25px 30px", display: "flex", flexDirection: "column", gap: "20px", border: "1px solid rgb(230, 230, 230)" }}>
