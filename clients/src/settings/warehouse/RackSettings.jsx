...
const RackSettingsModal = ({ onClose }) => {
    ...
    useEffect(() => {
        ...
        const loadRacks = async () => {
            const { data } = await api.get(`/api/warehouse/${selectedId}`);
    ...
    const handleMerge = async () => {
        ...
        await api.patch(`/api/warehouse/${selectedId}/merge-racks`);
    ...
    const saveRack = async () => {
        await api.put(`/api/warehouse/${selectedId}/update-rack`, editRack);
        toast.success("Saved");
        setEditRack(null);
        const { data } = await api.get(`/api/warehouse/${selectedId}`);
        setRacks(data.warehouse.racks);
