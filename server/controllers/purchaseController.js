...
//     try {
//     const { Product, CreatePurchase:Purchase, StockHistory, Supplier, DebitNote, PurchaseReturn } = await getAutoModels(req);
...
//     try {
//         const { CreatePurchase:Purchase } = await getAutoModels(req);
...
//     try {
//       const { CreatePurchase:Purchase, Supplier, Product } = await getAutoModels(req);
...
//     try {
//         const { CreatePurchase:Purchase, Product, StockHistory, Supplier } = await getAutoModels(req);
...
//   try {
//     const { PurchaseReturn, CreatePurchase:Purchase, Product, StockHistory } = await getAutoModels(req);
...
//   try {
//     const { DebitNote } = await getAutoModels(req);
...
//     try {
//         const { PurchaseReturn } = await getAutoModels(req);
...
//   try {
//     const { CreatePurchase:Purchase, Supplier } = await getAutoModels(req);
