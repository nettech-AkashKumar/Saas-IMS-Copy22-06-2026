...
const getPosSaleModel = (conn) => {
  if (!conn) {
    return mongoose.models.PosSale || mongoose.model('PosSale', posSaleSchema);
  }
  return conn.models.PosSale || conn.model('PosSale', posSaleSchema);
};

const forMaster = (conn) => {
  return getPosSaleModel(conn);
};
...
const PosSaleModel = getPosSaleModel();
PosSaleModel.forMaster = forMaster;
PosSaleModel.forTenant = forTenant;
