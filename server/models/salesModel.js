...
const getSalesModel = (conn) => {
  if (!conn) {
    return mongoose.models.Sales || mongoose.model("Sales", salesSchema);
  }
  return conn.models.Sales || conn.model("Sales", salesSchema);
};

const forMaster = (conn) => {
  return getSalesModel(conn);
};
...
const SalesModel = getSalesModel();
SalesModel.forMaster = forMaster;
SalesModel.forTenant = forTenant;
